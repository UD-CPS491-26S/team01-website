...
const pillars = [
  ...
  },
  {
    ...
    body: "The system introduces automated struct entropy, control flow obfuscation, metamorphism, and runtime integrity verification designed to disrupt cheating techniques.",
  },
  {
    num: "04",
